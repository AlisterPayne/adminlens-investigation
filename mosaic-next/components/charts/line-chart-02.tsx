...
export default function LineChart02({ data, width, height }: LineChart02Props) {
      ...
      <div className="px-5 py-3">
        <div className="flex flex-wrap items-end justify-between gap-x-4 gap-y-2">
          <div className="flex items-start">
            <div className="mr-2 text-3xl font-bold text-gray-800 dark:text-gray-100">$1,482</div>
            <div className="rounded-full bg-red-500/20 px-1.5 text-sm font-medium text-red-700">-22%</div>
          </div>
