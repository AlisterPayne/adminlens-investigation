    ...
    <>
      <div className="px-5 py-3">
        <div className="flex items-start">
          <div className="mr-2 text-3xl font-bold text-gray-800 tabular-nums dark:text-gray-100">
            $<span ref={chartValue}>57.81</span>
          </div>
          <div ref={chartDeviation} className="rounded-full px-1.5 text-sm font-medium"></div>
        </div>
      </div>
      <div className="grow">
