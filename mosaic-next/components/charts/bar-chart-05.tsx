...
export default function BarChart05({ data, width, height }: BarChart05Props) {
      ...
      <div className="px-5 py-3">
        <div className="flex flex-wrap items-end justify-between gap-x-4 gap-y-2">
          <div className="flex items-center">
            <div className="mr-2 text-3xl font-bold text-gray-800 dark:text-gray-100">$1,347.09</div>
